...
const I18N_TRANSLATIONS = {
    en: {
        ...
        sec_cf_title: "Universal Modpack Downloader",
        sec_cf_desc_prefix: "Download clean modpacks from ",
        sec_cf_desc_or: "or ",
        sec_cf_desc_suffix: " into server_modpacks/ folder (without world).",
        ph_cf_input: "Paste link or slug (e.g. better-mc-forge-bmc4)",
        btn_cf_search: "🔍 Search Modpack",
        hint_cf_support: "Supports full URLs, slugs or numeric IDs.",
        meta_file: "📁 File:",
    ...
    it: {
        ...
        sec_cf_title: "Universal Modpack Downloader",
        sec_cf_desc_prefix: "Scarica modpack puliti da ",
        sec_cf_desc_or: "o ",
        sec_cf_desc_suffix: " nella cartella server_modpacks/ (senza mondo).",
        ph_cf_input: "Incolla link o slug (es. better-mc-forge-bmc4)",
        btn_cf_search: "🔍 Cerca Modpack",
        hint_cf_support: "Supporta URL completi, slug o ID numerici.",
        meta_file: "📁 File:",
